...
##### Define the true affairs in the population {-} (??? bin mir nicht sicher, ob affairs wirklich ein passender begriff hier ist. vielleicht einfach nur "define the true model in the population"?)
