...
If you are unsure or have a more complicated model (or both), `semPower` also includes a convenience function called `semPower.getDf` that determines the df for a (single-group) model provided in the `lavaan` syntax (note that this function requires the `lavaan` package). For the model sketched above, running 
