...
* `type = IG` (Foldnes & Olsson, 2016) requires provision of skewness and excess kurtosis of the marginals (for each variable) akin to the Vale-Maurelli procedure.
