...
#' \dontrun{
#' 
#' ap <- semPower(type = 'a-priori', effect = .08, effect.measure = "RMSEA", alpha = .05, beta = .05, df = 200)
#' summary(ph)
#' 
#' ph <- semPower(type = 'post-hoc', effect = .08, effect.measure = "RMSEA", alpha = .05, N = 250, df = 200)
#' summary(ph)
#' 
#' cp <- semPower(type = 'compromise', effect = .08, effect.measure = "RMSEA", abratio = 1, N = 250, df = 200)
#' summary(ph)
#' }
