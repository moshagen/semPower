...
Note that `semPower.powerMI` implements variance scaling of the factors. In models assuming configural invariance, the variances of all factors are equal to 1 in all groups. In models assuming invariance of the loadings (metric invariance and higher), the factors variances are equal to 1 in one group and freely estimated in all other groups.
